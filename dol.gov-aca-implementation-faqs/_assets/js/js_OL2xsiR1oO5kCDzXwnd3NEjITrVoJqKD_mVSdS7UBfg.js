...
function isPartOfMegamenu(element){
    return $(element).parent().hasClass('has-children');
}
    ...
    $("a, area", context).each(function(el) {
      try {
        ...
        if (url.indexOf('http') == 0
          ...
          if (!isInExtraLeavingContainer(this)&& !isPartOfMegamenu(this)) {
            $(this).addClass('extlink');
          }
        if(!isPartOfMegamenu(this)){
